...
public class UserController {
 ...
 // handler method to handle list of users
    ...
    public String user(Model model, @PathVariable("id") Long id,Authentication auth){
    	...
    	List<PetDto> pets = petService.findPetsByUserId(id);
    ...
    public String changePassword(Model model, UserDto userDto, @RequestParam(name = "id") Long id,Authentication auth) {
